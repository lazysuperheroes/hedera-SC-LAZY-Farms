...
const main = async () => {
	...
	if (args.length != 5 || getArgFlag('h')) {
		console.log('Usage: stakeNFT.js 0.0.SSS 0.0.CCC1,0.0.CCC2,0.0.CCC3 S1,S2:S3,S4, R1,R2:R3,R4 <boostRate>');
		...
		console.log('		Example: stakeNFT.js 0.0.123 0.0.456,0.0.789 1,2,5:3,4,9 5,10,1:20,2,4 100');
		return;
	}
	...
	console.log('Stake executed. Transaction ID:', result[2]?.transactionId?.toString());
