...
const main = async () => {
	...
	if (args.length != 4 || getArgFlag('h')) {
		console.log('Usage: transferFundsFromBoostManager.js 0.0.BBBB 0.0.TTTT [hbar|lazy] <amount>');
		console.log('       BBBB is the mission factory address');
	...
	if (args[2].toLowerCase() == 'hbar') {
		...
		console.log('Usage: transferFundsFromBoostManager.js 0.0.MMMM 0.0.TTTT [hbar|lazy] <amount>');
	...
	console.log('\n-Proposed Admin:', recAddress.toString());
