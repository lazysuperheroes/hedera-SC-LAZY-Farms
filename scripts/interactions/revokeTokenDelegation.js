...
const main = async () => {
	...
	if (args.length != 3 || getArgFlag('h')) {
		console.log('Usage: delegateToken.js 0.0.LDR 0.0.TOKEN <serials>');
		console.log('Example: delegateToken.js 0.0.1234 0.0.5678 1,2,3');
		return;
	}
	...
	console.log('**REVOKING TOKEN DELEGATION');
	...
	console.log('Serial(s) Revoked. Transaction ID:', result[2]?.transactionId?.toString());
};
