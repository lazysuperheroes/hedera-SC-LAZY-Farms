...
const main = async () => {
	...
	if (args.length != 3 || getArgFlag('h')) {
		console.log('Usage: addCollectionToBoostLevel.js 0.0.BBB <rank> 0.0.GGGG1,0.0.GGGG2,0.0.GGGG3');
	...
	console.log('\n-**ADDING COLLECTION TO BOOST LEVEL**');
	...
	// individually to hanldle already associated tokens
