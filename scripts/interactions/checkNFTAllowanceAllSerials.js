...
const main = async () => {
	...
	if (args.length != 4 || getArgFlag('h')) {
		console.log('Usage: checkNFTAllowanceAllSerials.js 0.0.CCC 0.0.TOKEN 0.0.OWNER 0.0.SPENDER');
		console.log('       CCC is the LazyAllowanceUtility address');
		console.log('       0.0.TOKEN is the NFT token we are checking All Serials for');
