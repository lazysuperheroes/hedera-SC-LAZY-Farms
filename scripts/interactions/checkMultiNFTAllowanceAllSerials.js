...
const main = async () => {
	...
	if (args.length != 4 || getArgFlag('h')) {
		console.log('Usage: checkMultiNFTAllowanceAllSerials.js 0.0.CCC 0.0.TOKEN1,0.0.TOKEN2 0.0.OWNER1,0.0.OWNER2 0.0.SPENDER1,0.0.SPENDER2');
	...
	for (let i = 0; i < tokenList.length; i++) {
		console.log('Token:', tokenList[i].toString(), 'Owner:', ownerList[i].toString(), 'Spender:', spenderList[i].toString(), 'All serials approved:', Boolean(approved[0][i]));
	}
