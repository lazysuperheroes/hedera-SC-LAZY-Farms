/**
 * Transfer HBAR or $LAZY from a MissionFactory contract
...
const main = async () => {
	...
	const args = parseArgs(4, 'transferFundsFromMissionFactory.js 0.0.MMMM 0.0.TTTT [hbar|lazy] <amount>', [
	...
	printHeader({
		scriptName: 'Transfer Funds from MissionFactory',
		env,
